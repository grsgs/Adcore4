...
#define MIN_TRINITY_STRING_ID           1                    // 'depthscore_string'
...
class ObjectMgr
{
    ...
    public:
        ...
        bool LoadTrinityStrings() { return LoadTrinityStrings("depthscore_string", MIN_TRINITY_STRING_ID, MAX_TRINITY_STRING_ID); }
