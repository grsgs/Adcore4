...
public:
    ...
    ChatCommand* GetCommands() const
    {
        ...
        static ChatCommand reloadCommandTable[] =
        {
            ...
            { "depthscore_string",               SEC_ADMINISTRATOR, true,  &HandleReloadTrinityStringCommand,              "", NULL },
    ...
    {
        TC_LOG_INFO(LOG_FILTER_GENERAL, "Re-Loading depthscore_string Table!");
        sObjectMgr->LoadTrinityStrings();
        handler->SendGlobalGMSysMessage("DB table `depthscore_string` reloaded.");
        return true;
    }
